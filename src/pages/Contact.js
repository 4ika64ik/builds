            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">Связаться с нами</h1>
                        </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: 12345679</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">E-mail</h2>
                                <p className="text-gray-400">babajanovasabrina4@gmail.com</p>
                            </div>
